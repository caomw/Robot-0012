...
Sergio Castillo-Hernández(25\%): Navigation and path planning\\ 
Vince Jankovics (25\%): Navigation and path plannin\\ 
...
\begin{document}
	...
	\input{./sections/robot} \label{sec:robot}
