...
We mainly focus on two aspects when configuring the Lego robot, namely {\itshape \romannum{1})} stability and {\itshape \romannum{2})} feasibility. The complete configuration of the robot is visualised in Fig.\ref{fig:robotconfig}, where there are three images showing the front, side and back appearances of the robot respectively. 
